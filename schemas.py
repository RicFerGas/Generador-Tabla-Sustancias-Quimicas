...
class HDSData(BaseModel):
    ...
    componentes: List[componente] = Field(..., alias='Componentes', description='Componentes de la sustancia química, se encuentran en la Sección 3 de la HDS')
    ...
    palabra_advertencia: Optional[str] = Field(None, alias='Palabra de Advertencia', description='Palabra de advertencia de la sustancia química, se encuentra en la Sección 2 de la HDS')
