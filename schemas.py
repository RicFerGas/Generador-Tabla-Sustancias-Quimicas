...
class HDSData(BaseModel):
    ...
    sujeta_retc: Optional[str] = Field(None, alias='Sujeta a RETC', description='Elige una de las 3 opciones [NO, SI, REVISAR] Indica si la sustancia química está sujeta o podria estar sujeta al Reglamento de Evaluación de la Conformidad con la NOM-165-SEMARNAT-2013 de México')
    sujeta_gei: Optional[str] = Field(None, alias='Sujeta a GEI', description='Elige una de las 3 opciones [NO, SI, REVISAR] Indica si la sustancia química está sujeta o podria estar sujeta a reporte de  Gases de Efecto Invernadero de conformidad con ACUERDO:Qué establece los gases o compuestos de efecto invernadero que se agrupan para efectos de reporte de emisiones, así como sus potenciales de calentamiento en Mexico por la semarnat')
